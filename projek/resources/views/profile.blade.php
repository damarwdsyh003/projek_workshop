            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="{{ route('profile')}}"class="active">Profile <img src="assets/img/profile-header.jpg" alt=""></a></li>
                    </ul>
        ...
        <div class="page-content">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="main-profile ">
                <div class="row">
                  <div class="col-lg-4">
                    <img src="assets/img/profile.jpeg " alt="" style="border-radius: 23px; height:320px;width:300px">
                  </div>
                    ...
                    <div class="clips">
                      <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                          <div class="item">
                            <div class="thumb">
                              <img src="assets/img/inca.png" alt="" style="border-radius: 23px;">
          ...
          <div class="gaming-library profile-library">
            <div class="col-lg-12">
              ...
              <div class="item">
                <ul>
                  <li><img src="assets/img/inca.png" alt="" class="templatemo-item"></li>
